...
public class LimitThresholdTest {
    ...
    public void setUp() throws Exception {
        ...
        Field cvField = LimitThreshold.class.getDeclaredField("candidatevalue");
        cvField.setAccessible(true);
        cvField.set(lt, candidateValueMock);
    }
    ...
    public void testGenerate() throws Exception {
        ...
        lt.setInitialReference(refState);
    ...
    public void testUpdateReference() throws Exception {
        ...
        try (MockedConstruction<FactoryAcceptCandidate> mockedFactory = mockConstruction(FactoryAcceptCandidate.class,
            ...
            lt.updateReference(candidate, 1);
            
            assertEquals(candidate, lt.getReference());
            ...
            lt.updateReference(rejectedCandidate, 1);
            
            assertEquals(candidate, lt.getReference()); // Should remain the previous one
        }
    }
